...
function Footer() {
  return (
    <div className='container grid-container--footer grid bg-dark flow--footer'>
      ...
      <p className='footer--publish text-dark-gray'>  © 2021 Loopstudios. All rights reserved.</p>
